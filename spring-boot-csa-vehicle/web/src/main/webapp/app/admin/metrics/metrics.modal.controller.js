(function() {
    ...
    angular
        .module('csaApp')
        .controller('CsaMetricsMonitoringModalController', CsaMetricsMonitoringModalController);

    CsaMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function CsaMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
