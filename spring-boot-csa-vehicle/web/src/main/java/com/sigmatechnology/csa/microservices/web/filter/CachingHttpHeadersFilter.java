package com.sigmatechnology.csa.microservices.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    private CsaProperties jHipsterProperties;

    public CachingHttpHeadersFilter(CsaProperties jHipsterProperties) {
