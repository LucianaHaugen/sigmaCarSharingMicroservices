...
import com.sigmatechnology.csa.microservices.gateway.ratelimiting.RateLimitingFilter;
import com.sigmatechnology.csa.microservices.gateway.ratelimiting.RateLimitingRepository;
import com.sigmatechnology.csa.microservices.gateway.accesscontrol.AccessControlFilter;
import com.sigmatechnology.csa.microservices.gateway.responserewriting.SwaggerBasePathRewritingFilter;
...
public class GatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty("csa.gateway.rate-limiting.enabled")
    public static class RateLimitingConfiguration {

        @Inject
        private CsaProperties csaProperties;
        ...
        public RateLimitingFilter rateLimitingFilter() {
            return new RateLimitingFilter(rateLimitingRepository(), csaProperties);
        }
    }
}
