...
/**
 * Properties specific to Csa.
 *
 * <p>
 *     Properties are configured in the application.yml file.
 * </p>
 */
@ConfigurationProperties(prefix = "csa", ignoreUnknownFields = false)
public class CsaProperties {
    ...
    public static class Swagger {
        ...
        private String title = "csaGateway API";

        private String description = "csaGateway API documentation";
