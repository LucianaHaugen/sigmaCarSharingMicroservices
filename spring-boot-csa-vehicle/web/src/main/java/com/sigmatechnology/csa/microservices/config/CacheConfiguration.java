...
public class CacheConfiguration {
    ...
    @Bean
    public HazelcastInstance hazelcastInstance(CsaProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("com.sigmatechnology.csa.microservices.domain.*", initializeDomainMapConfig(jHipsterProperties));
    ...
    private MapConfig initializeDomainMapConfig(CsaProperties jHipsterProperties) {
        MapConfig mapConfig = new MapConfig();
    ...
    */
    ...
    private MapConfig initializeClusteredSession(CsaProperties jHipsterProperties) {
        MapConfig mapConfig = new MapConfig();
