package com.sigmatechnology.csa.microservices.gateway.ratelimiting;

import com.sigmatechnology.csa.microservices.config.CsaProperties;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(RateLimitingRepository rateLimitingRepository, CsaProperties jHipsterProperties) {
